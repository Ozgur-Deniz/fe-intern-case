...
function SidebarHeader() {
  return (
    <div className="flex flex-row items-center justify-evenly max-lg:justify-start w-full h-[100px] border-[#ececeb] border-b-2">
      ...
      <IoMdMenu className="max-lg:hidden text-[30px] text-[#3F4059]" />
    </div>
  );
}
