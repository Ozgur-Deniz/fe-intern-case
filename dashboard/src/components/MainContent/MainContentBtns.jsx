...
function mainContentBtns() {
  return (
    <div className="flex  flex-row items-center justify-center gap-2">
      <div className="max-lg:hidden border-[2px] border-[#ececeb] rounded-lg p-3 cursor-pointer">
        <LuRefreshCcw />
      </div>
      <div className="max-lg:hidden border-[2px] border-[#ececeb] rounded-lg p-3 cursor-pointer">
        <CiCalendar />
      ...
      <div className="border-[2px] border-[#ececeb] rounded-lg p-3 max-md:p-2 max-sm:p-1 cursor-pointer">
        <BsThreeDotsVertical />
      </div>
